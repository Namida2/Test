...
class DBHelperForTeachers extends SQLiteOpenHelper {
    private static String DB_PATH; // полный путь к базе данных
    private static String DB_NAME = "Teachers.db";
    private static final int SCHEMA = 1; // версия базы данных
    static final String TABLE = "Teachers"; // название таблицы в бд
    private Context myContext;

    static List<PairGroupPosition> listGroupPosition = new ArrayList<PairGroupPosition>();

    DBHelperForTeachers(Context context) {
